...
```{r}
ggplot(full_county_table, aes(x = Median_Household_Income_2019, y = Percent_No_Diploma)) +
  geom_point() +
...
ggplot(group_by_urb_table, aes(x = "Rural_urban_code", y = "Percent_Bachelors", fill = ..x..)) +
  geom_density_ridges_gradient(scale = 3, rel_min_height = 0.01) +
  scale_fill_viridis(name = "Rural_urban_code", option = "C") +
